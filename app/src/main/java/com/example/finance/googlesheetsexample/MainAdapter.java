...
class MainAdapter extends RecyclerView.Adapter<MainAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView WACCDetailedPageResultsSGANumber;
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
                ...
                WACCDetailedPageResultsSGANumber = (TextView)
    ...
    public void onBindViewHolder(@NonNull MainAdapter.ViewHolder viewHolder, int i) {
        ...
        viewHolder.WACCDetailedPageResultsSGANumber.setText(mDataset.get(i).get("WACCDetailedResultsSGANumber"));
